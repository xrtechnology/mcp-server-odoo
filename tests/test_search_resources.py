...
from mcp_server_odoo.resources import (
    OdooResourceHandler, register_resources, 
    ResourceError, ResourcePermissionError
)
...
class TestSearchResource:
    ...
    async def test_search_basic(self, resource_handler, mock_connection, mock_access_controller):
        ...
        mock_connection.search.assert_called_once_with('res.partner', [], limit=10, offset=0, order=None)
    ...
    @pytest.mark.asyncio
    async def test_search_with_domain(self, resource_handler, mock_connection, mock_access_controller):
    ...
    @pytest.mark.asyncio
    async def test_search_with_fields(self, resource_handler, mock_connection, mock_access_controller):
    ...
    @pytest.mark.asyncio
    async def test_search_with_pagination(self, resource_handler, mock_connection, mock_access_controller):
    ...
    @pytest.mark.asyncio
    async def test_search_with_order(self, resource_handler, mock_connection, mock_access_controller):
        ...
        # Execute search
        result = await resource_handler._handle_search(
            'res.partner', None, None, None, None, order
        )
    ...
    @pytest.mark.asyncio
    async def test_search_empty_results(self, resource_handler, mock_connection, mock_access_controller):
    ...
    async def test_search_access_denied(self, resource_handler, mock_access_controller):
        ...
        with pytest.raises(ResourcePermissionError) as exc_info:
            await resource_handler._handle_search(
                'sale.order', None, None, None, None, None
            )
        
        assert "Access denied" in str(exc_info.value)
    
    @pytest.mark.asyncio
    async def test_search_connection_error(self, resource_handler, mock_connection, mock_access_controller):
    ...
    @pytest.mark.asyncio
    async def test_search_limit_validation(self, resource_handler, mock_connection, mock_access_controller):
        ...
        mock_connection.search.assert_called_with('res.partner', [], limit=100, offset=0, order=None)
    
    @pytest.mark.asyncio
    async def test_search_invalid_domain(self, resource_handler, mock_connection, mock_access_controller):
        ...
        result = await resource_handler._handle_search(
            'res.partner', invalid_domain, None, None, None, None
        )
    ...
    @pytest.mark.asyncio
    async def test_search_large_dataset_summary(self, resource_handler, mock_connection, mock_access_controller):
        ...
        mock_connection.search.return_value = list(range(1, 11))
        mock_connection.read.return_value = [{'id': i, 'name': f'Partner {i}'} for i in range(1, 11)]
        mock_connection.fields_get.return_value = {}
