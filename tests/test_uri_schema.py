...
from mcp_server_odoo.uri_schema import (
    parse_uri, build_uri, build_search_uri, build_record_uri,
    build_pagination_uri, extract_model_from_uri,
    OdooURI, OdooOperation,
    URIError, URIParseError, URIValidationError
)
...
class TestURIParsing:
    ...
    def test_odoo_uri_to_uri(self):
        ...
        original = "odoo://res.partner/search?domain=[('is_company','=',True)]&fields=name,email&limit=10"
...
class TestURIBuilding:
    ...
    def test_build_search_uri_with_domain(self):
        ...
        assert uri == "odoo://res.partner/search?domain=%5B%28%27is_company%27%2C%27%3D%27%2CTrue%29%5D"
...
class TestURIConvenienceFunctions:
    ...
    def test_extract_model_from_uri(self):
        ...
        assert extract_model_from_uri("odoo://account.invoice.line/fields") == "account.invoice.line"
