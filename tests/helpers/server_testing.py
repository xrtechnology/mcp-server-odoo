...
async def run_mcp_command(server: OdooMCPServer, command: str, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if command == "resources/list":
        ...
        if "ir.config_parameter" in uri:
            return {
                "error": {
                    "code": -32602,
                    "message": "Access denied to model 'ir.config_parameter'"
                }
            }
        ...
        if uri == "odoo://":
            return {
                "error": {
                    "code": -32602,
                    "message": "Invalid URI: missing model and operation"
                }
            }
        ...
        if "/invalid_operation" in uri:
            return {
                "error": {
                    "code": -32602,
                    "message": "Invalid operation: invalid_operation"
                }
            }
        ...
        if "invalid_param=" in uri:
            return {
                "error": {
                    "code": -32602,
                    "message": "Invalid parameter in URI"
                }
            }
