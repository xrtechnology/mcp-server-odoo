...
from mcp_server_odoo.access_control import (
    AccessController, AccessControlError, ModelPermissions, CacheEntry
)
...
class TestAccessControl:
    ...
    def test_get_all_permissions(self, mock_urlopen, controller):
        ...
        mock_urlopen.return_value.__enter__.side_effect = [
            models_response, partner_response, users_response
        ]
...
class TestAccessControlIntegration:
    ...
    def test_real_model_permissions(self, real_config):
        ...
        assert perms.model == "res.partner"
        assert perms.enabled is True
        print(f"res.partner permissions: read={perms.can_read}, "
