...
from mcp_server_odoo.server import OdooMCPServer, SERVER_VERSION
...
class TestServerIntegration:
    ...
    def test_server_with_env_file(self, tmp_path, monkeypatch):
        ...
        from mcp_server_odoo.config import reset_config, load_config
...
""")
        ...
        try:
            ...
            for key in ["ODOO_URL", "ODOO_API_KEY", "ODOO_DB", "ODOO_MCP_LOG_LEVEL", 
    ...
    async def test_real_odoo_connection(self):
        ...
        try:
            ...
            import traceback
            pytest.skip(f"Integration test skipped (unexpected error): {type(e).__name__}: {e}\n{traceback.format_exc()}")
        finally:
