...
class TestBrowseResource:
    ...
    @pytest.mark.asyncio
    async def test_browse_multiple_records(self, resource_handler, mock_connection, mock_access_controller):
    ...
    @pytest.mark.asyncio
    async def test_browse_with_missing_records(self, resource_handler, mock_connection, mock_access_controller):
    ...
    @pytest.mark.asyncio
    async def test_browse_invalid_ids(self, resource_handler, mock_connection, mock_access_controller):
...
class TestCountResource:
    ...
    @pytest.mark.asyncio
    async def test_count_all_records(self, resource_handler, mock_connection, mock_access_controller):
    ...
    @pytest.mark.asyncio
    async def test_count_with_domain(self, resource_handler, mock_connection, mock_access_controller):
    ...
    @pytest.mark.asyncio
    async def test_count_complex_domain(self, resource_handler, mock_connection, mock_access_controller):
    ...
    @pytest.mark.asyncio
    async def test_count_zero_results(self, resource_handler, mock_connection, mock_access_controller):
        ...
        result = await resource_handler._handle_count(
            'res.partner', 
            quote(json.dumps([['name', '=', 'NonExistent']]))
        )
...
class TestFieldsResource:
    ...
    @pytest.mark.asyncio
    async def test_fields_with_selection(self, resource_handler, mock_connection, mock_access_controller):
        ...
        assert 'Options: contact (Contact), invoice (Invoice Address), delivery (Delivery Address), other (Other), private (Private)' in result
    
    @pytest.mark.asyncio
    async def test_fields_with_numeric(self, resource_handler, mock_connection, mock_access_controller):
...
class TestAdvancedResourceIntegration:
    ...
    async def test_count_real_records(self, real_config, real_connection):
        ...
        domain = [['is_company', '=', True]]
        result_companies = await handler._handle_count(
            'res.partner', 
